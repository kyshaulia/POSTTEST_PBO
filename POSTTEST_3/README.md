...
3. Atribut Private Class Hijab

   ![Atribut Private Hijab](assets/pbo%20private%20atribut.PNG)

   Atribut diubah menjadi private untuk menerapkan Encapsulation.

4. Getter dan Setter

   ![getter-setter](assets/getter-setter.PNG)
...
6. Fitur Program
    ...
    ![Menu Tambah Hijab](assets/pbo_voidtambah.PNG)
   ...
   ![pbo-lihatdata.PNG](assets/pbo-lihatdata.PNG)
   ...
   ![Menu Update Data](assets/pbo_voidupdate.PNG)

   ![update-lanjutan](assets/update.PNG)
...
8. Penerapan Inheritance
   ...
   Hijab {nama, warna, kategori, stok, harga, tampilkanData()}
   ...
   ![subclass-segiempat](assets/subclass-segiempat.PNG)

   b. Subclass Pashmina

   ![subclass-pashmina](assets/subclass-pashmina.PNG)

   c. Subclass Bergo

   ![subclass-bergo](assets/subclass-bergo.PNG)

   d. Subclass Instan

   ![subclass-instan](assets/subclass-instan.PNG)

   e. Subclass Khimar

   ![subclass-khimar](assets/subclass-khimar.PNG)
